...
6. Every finding: file:line, how it fails in one concrete case, the smallest fix or test. No praise, no rewrites, no style the project's linter does not enforce.
